...
def get_tree():
    ...
    if sc_tree.find_one({"pkg":pkg,"time":time}):
        ...
        return {"pkg":pkg,"time":time,"tree":tree,"package_number":len(supplychain.node_index),"project_number":len(supplychain.project),"layer":layer_number,"degree":degree,"max_layer":supplychain.max_layer}